...
//     } else {
//         if (bwin > -900)
//             _drawingContext.GradsDatabase.gxdboutbck(bwin);  /* change the background color if user provided an override */
...
//
//         if (tcolor != -1) _drawingContext.GradsDatabase.gxdbsettransclr (tcolor);   /* tell graphics database about transparent color override */
//
//         int rc = 0;
...
//
//         _drawingContext.GradsDatabase.gxdbsettransclr (-1);    /* unset transparent color override */
//         return (rc);
//         
//     }
//
...
//     _drawingContext.GradsDatabase.gxdboutbck(-1);       /* unset output background color */
//
...
//     {
//         var c = _drawingContext.GradsDatabase.gxdbqcol(col);
...
//         drawing = 0;
//         lwidth = wid;
//         _lineWidth = (float)_drawingContext.GradsDatabase.gxdbqwid(wid - 1);
//         
//     }
//
